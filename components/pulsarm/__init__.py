...
from .const import CONF_PULSARM_ID, CONF_IS_ENABLE
...
pulsarm_component_ns = cg.esphome_ns.namespace("pulsarm")
PulsarMComponent = pulsarm_component_ns.class_("PulsarMComponent", cg.Component)
